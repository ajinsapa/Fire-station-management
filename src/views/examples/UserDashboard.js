  ...
  return (
    <div>
      ...
      <div className="mt-5 b1" style={{ display: 'flex' }}>
        <div style={{ flex: 3, backgroundColor: 'beige', paddingTop: '20px' }}></div>
        <div style={{ backgroundColor: 'beige', paddingTop: '20px', display: 'flex' }} className="b3 text-dark">
          <p>
            ...
            <p className="text-black ">
              ...
              <b>
                {' '}
                Welcome to our incident reporting platform for the <b> Nova Fire and Rescue Services </b>. Here, you can
                easily register any incidents or emergencies you encounter within our jurisdiction. Your prompt reporting
                helps us respond quickly and effectively to ensure the safety and well-being of our community.
              </b>
            </p>
            <p>
              {' '}
              <b>
                {' '}
                Our team of trained professionals is dedicated to providing swift assistance and resolving incidents
                efficiently. By registering incidents through our platform, you contribute to the collective effort of
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Row className="mb-3">
              <Form.Group as={Col} md="4" controlId="validationCustom01">
                ...
                <Form.Control required type="text" onChange={(e) => setIncidentInputs(e)} name={'location'} />
                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
              </Form.Group>
              <Form.Group as={Col} md="4" controlId="validationCustom02">
                <Form.Label>Date & Time</Form.Label>
                <Form.Control required type="text" placeholder="yyyy-mm-dd hh:mm:ss" onChange={(e) => setIncidentInputs(e)} name={'date_time'} />
              </Form.Group>
              <Form.Group as={Col} md="4" controlId="validationCustom02">
                <Form.Label>Incident Type</Form.Label>
                <Form.Control required type="text" onChange={(e) => setIncidentInputs(e)} name={'type'} />
              </Form.Group>
              <Form.Group as={Col} md="4" controlId="validationCustom02">
                <Form.Label>Severity</Form.Label>
                <Form.Control required type="text" name={'severity'} onChange={(e) => setIncidentInputs(e)} />
              </Form.Group>
            </Row>
            <Row className="mb-3">
              <Form.Group as={Col} md="6" controlId="validationCustom03">
                <Form.Label>Description</Form.Label>
                <Form.Control type="text" onChange={(e) => setIncidentInputs(e)} name={'description'} required />
                <Form.Control.Feedback type="invalid"></Form.Control.Feedback>
              </Form.Group>
            </Row>
            <Button className="butt5" onClick={(e) => handleAddIncident(e)} style={{ backgroundColor: 'brown' }} type="submit">
              Create
            </Button>
          </Form>
        </Modal.Body>
